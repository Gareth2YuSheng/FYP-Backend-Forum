...
exports.appRoute = router => {
    ...
    router.put("/reply/:r_id/upvote", verifyFn.verifyToken, validationFn.validateVoteForumReply, replyController.upvoteForumReply);
    router.put("/reply/:r_id/downvote", verifyFn.verifyToken, validationFn.validateVoteForumReply, replyController.downvoteForumReply);
